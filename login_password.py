...
while True:
    if not access:
        ...
        print("Меню:")
        git = int(input("введите 1 что-бы запустить текстокрафт, введите 2 что-бы запустить магический шар, введите 3 что-бы запустить cyberpunk_2077, введите 4 что-бы запустить список желаний, введите 5 что-бы запустить новогоднюю игру, введите 6 что-бы запустить "))
        if git == "1":
            fain()
        if git == "2":
            main()
